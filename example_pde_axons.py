...
if __name__ == "__main__":
    ...
    par = fct.set_parameters(
        temp[index_set_parameters]
    ...
    time_denerv1 = 60.5  # time chosen for the denervation of sympathetic axons
    time_denerv2 = 40  # time chosen for the denervation of sensory axons
    # we plot the evolution of cancer cells subject to the in silico denervation
    fct.denerv_dyn_system(time_denerv1, time_denerv2, init_data, par)
